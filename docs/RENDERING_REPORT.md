...
- 2026-06-10 线上复核：`/gif/` hero 已完成加载且 mobile/tablet 尺寸对齐；但 `domcontentloaded + 15s` 后 GIF 缩略图多数仍未 `complete`，截图可能出现灰/空占位，后续应给 GIF gallery 增加轻量 `thumbSrc` 或静态 poster。
