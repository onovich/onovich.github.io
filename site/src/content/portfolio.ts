...
const baseCopy = {
  en: {
    ...
    projectDescriptions: {
      ninja: 'Released game · co-development · 1Poss Studio',
      golf: 'Terrain, route planning, and golf',
      inscape: 'Narrative editor · R&D',
      prism: 'Stylized modeling tool · R&D',
  ...
  'zh-CN': {
    ...
    projectDescriptions: {
      ninja: '已发行游戏 · 与 1Poss Studio 合作开发',
      golf: '地形、路线规划与高尔夫',
      inscape: '剧情编辑器 · 研发',
      prism: '风格化建模工具 · 研发',
