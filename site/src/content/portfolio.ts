...
export const copy = {
  en: {
    ...
    contact: {
      ...
      formSubject: 'Website contact from the Onovich portfolio',
      formNote: 'Submitting opens your email client with the message prepared. If it does not open, email me directly at onovich1110@gmail.com.',
    },
  },
  'zh-CN': {
    skip: '跳到主要内容',
    ...
    contact: {
      ...
      formMessage: '留言内容',
      formSubmit: '打开邮件草稿',
      formSubject: '来自 Onovich 作品集网站的联系',
      formNote: '提交后会打开你设备上的邮件客户端并预填内容。如果没有打开，请直接发送至 onovich1110@gmail.com。',
    },
  },
} as const;
